...
class NewsScraper():
    ...
    def get_news_urls(self):
        ...
        links_xpath = 'a[class="link__CustomNextLink-sc-1r7l32j-0 eoKbWT BrowseArticleListItemDesktop__WrapperLink-zb6c6m-6 bzMtyO"]'
    ...
    def get_data_from_urls(self, urls):
        ...
        for url in urls:
            ...
            if (url.startswith("https://www.zoomg.ir")):
                ...
                try:
                    ...
                    content_xpath = '//div[@class="BlockContainer__InnerArticleContainer-i5s1rc-1 hXzioD"]//p'
                    ...
                    content = self.get_text_elements(xpath=content_xpath)[:-3]
                    tags = self.get_text_elements(xpath=tags_xpath),

                    new_content = " "
                    for con in content:
                        cont = " ".join(re.split("\u200c", con))  # split on half space and join with space
                        new_content += cont + " "
        ...
        skipped = len(zoomg_urls) + len(pedal_urls) + len(zoomit2_urls)
...
start_url = 'https://www.zoomit.ir/archive/?sort=Newest'
